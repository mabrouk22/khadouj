            ...
            306: function (e) {
                !(function (t) {
                    ...
                    var n = (function () {
                            return {
                                ...
                                mimeType: function (e) {
                                    ...
                                    return (
                                        ...
                                        (o = "image/jpeg"),
                                        { woff: r, woff2: r, ttf: "application/font-truetype", eot: "application/vnd.ms-fontobject", png: "image/png", jpg: o, jpeg: o, gif: "image/gif", tiff: "image/tiff", svg: "image/svg+xml" })[n] || ""
                                    );
                                    var r, o;
                                },
                                ...
                                getAndEncode: function (e) {
                                    ...
                                    return new Promise(function (n) {
                                        ...
                                        if (((o.onreadystatechange = a), (o.ontimeout = c), (o.responseType = "blob"), (o.timeout = t), o.open("GET", e, !0), o.send(), u.impl.options.imagePlaceholder)) {
                                        ...
                                        function a() {
                                            if (4 === o.readyState)
                                                ...
                                                } else r ? n(r) : l("cannot fetch resource: " + e + ", status: " + o.status);
                                        }
                                        function c() {
                                            r ? n(r) : l("timeout of " + t + "ms occured while fetching resource: " + e);
                                        }
                                        function l(e) {
                                            console.error(e), n("");
                                        }
                        ...
                        a = { imagePlaceholder: void 0, cacheBust: !1 },
                        u = {
                            toSvg: c,
                            toPng: function (e, t) {
                    ...
                    function c(e, t) {
                        return (
                            (function (e) {
                                void 0 === e.imagePlaceholder ? (u.impl.options.imagePlaceholder = a.imagePlaceholder) : (u.impl.options.imagePlaceholder = e.imagePlaceholder);
                                void 0 === e.cacheBust ? (u.impl.options.cacheBust = a.cacheBust) : (u.impl.options.cacheBust = e.cacheBust);
                            })((t = t || {})),
                            Promise.resolve(e)
                                .then(function (e) {
        ...
        (() => {
            ...
            const r = (e, t, n) => {
                    document.querySelector(e).addEventListener("keyup", (e) => {
                        "background" == n
                            ? (document.querySelector(t).style.backgroundColor = e.target.value)
                            : "text" == n
                            ? (document.querySelector(t).style.color = e.target.value)
                            : "innerHTML" == n && (document.querySelector(t).innerHTML = e.target.value);
                    });
                },
                o = document.querySelector(".container_background_color");
            document.getElementById("input_background_color").addEventListener("change", (e) => {
                "custom" == e.target.value
                    ? (o.classList.remove("hidden"),
                      o.classList.add("grid"),
                      r("#input_hex_background_color", ".thumbnail_container,#post_title span", "background"),
                      r("#input_hex_text_color", ".thumbnail_container", "text"),
                      r("#input_hex_background_color", ".input_hex_background_color_preview", "background"),
                      r("#input_hex_text_color", ".input_hex_text_color_preview", "background"),
                      r("#input_hex_text_color", ".post_label_ornament", "background"))
                    : (o.classList.add("hidden"),
                      o.classList.remove("grid"),
                      (document.querySelector(".thumbnail_container").style.backgroundColor = e.target.value),
                      (document.querySelector(".thumbnail_container").style.color = "#ffffff"),
                      (document.querySelector("#post_title span").style.backgroundColor = e.target.value),
                      (document.querySelector("#post_title span").style.color = "#ffffff"),
                      (document.querySelector(".post_label_ornament").style.backgroundColor = "#ffffff"),
                      (document.querySelector("#input_hex_background_color").value = e.target.value),
                      (document.querySelector("#input_hex_text_color").value = "#ffffff"),
                      (document.querySelector(".input_hex_background_color_preview").style.backgroundColor = e.target.value),
            ...
            for (let e = 0; e < i.length; e++) {
                const t = i[e];
                a.innerHTML += `\n    <option value='${t}'>Background Image ${e}</option>\n    `;
            }
            a.addEventListener("change", (e) => {
                "none" != e.target.value
                    ? (document.querySelector(".background_image").classList.remove("hidden"),
                      ...
                      (document.querySelector(".background_image").style.backgroundImage = `url(${e.target.value})`))
                ...
                document.querySelector("#image_invert").addEventListener("change", (e) => {
                    e.target.checked
            ...
            document.getElementById("button_download_image").addEventListener("click", () => {
                t()
                    .toJpeg(u, { width: 1.5 * u.clientWidth, height: 1.5 * u.clientHeight, style: { transform: "scale(1.5)", transformOrigin: "top left" } })
                    .then(function (e) {
                        ((e, t) => {
                            let n = document.createElement(e);
                            for (var r in t) "class" == r ? n.classList.add.apply(n.classList, t[r]) : "content" == r ? (n.innerHTML = t[r]) : (n[r] = t[r]);
                            return n;
                        })("a", { href: e, download: "mabrouk_dejebabri_" + Math.round(9999 * Math.random()) + 1 }).click();
                    })
                    .catch(function (e) {
